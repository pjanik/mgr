...
Uproszczony schemat relaksacji metodą \ow{Jacobiego} na GPU prezentuje algorytm
\ref{alg:JacobiGPU}.
...
konsekwencje. Inna jest konwergencja tych dwóch algorytmów. Metoda \ow{Gaussa-
Seidela} jest szybciej zbieżna niż metoda \ow{Jacobiego}. Efekty symulacji dla
...
Na ww. rysunkach można zaobserwować wyraźne różnice w rezultatach symulacji.
Oczekiwanym wynikiem było powstane wiru Kármána dla większej przeszkody. W
przypadku implementacji równoległej metody \ow{Jacobiego} widać, iż porządany
...
podstawowej (sekwencyjnej, napisanej bez użycia technologii \ow{WebGL}).
...
ogólnego zastosowania na GPU, a także w przypadku symulatora \ow{Energy2D},
